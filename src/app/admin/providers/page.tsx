                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <p className="flex-1 min-w-0 font-medium text-[#1C1F26] dark:text-[#FAFAF8] font-['Space_Grotesk',sans-serif] break-words">
                        {p.user.name}
                      </p>
                      <span
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#1C1F26]/10 dark:border-white/10 text-left">
                      <th className="px-4 lg:px-5 py-3 text-xs font-semibold uppercase tracking-wide text-[#6B6A62] dark:text-[#9B9A92]">Provider</th>
                      <th className="px-4 lg:px-5 py-3 text-xs font-semibold uppercase tracking-wide text-[#6B6A62] dark:text-[#9B9A92]">Category</th>
                      <th className="px-4 lg:px-5 py-3 text-xs font-semibold uppercase tracking-wide text-[#6B6A62] dark:text-[#9B9A92]">Services</th>
                    ...
                    {providers.map((p) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 lg:px-5 py-4 text-[#6B6A62] dark:text-[#9B9A92] font-['IBM_Plex_Mono',monospace]">
                            {p.services.length}
                          </td>
