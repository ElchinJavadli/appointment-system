...
export default function ClientDashboard() {
  ...
  async function loadDashboard() {
    ...
    setFavoriteIds(new Set((favoritesData.favorites || []).map((f) => f.serviceId)));
    setLoading(false);
  }
      ...
      <section className="pt-16 pb-16 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-4 font-['Space_Grotesk',sans-serif] tracking-tight">
            Welcome back<span className="text-[#C2540A]">{user?.name ? `, ${user.name}` : ""}</span>
          </h1>
      ...
      <section className="max-w-6xl mx-auto px-6 mb-8">
        <div className="bg-white dark:bg-[#20242C] rounded-2xl border border-[#1C1F26]/10 dark:border-white/10 p-4 flex flex-wrap gap-3 items-center">
          ...
          <select
            ...
            className="text-sm bg-[#FAFAF8] dark:bg-[#14161B] border border-[#1C1F26]/15 dark:border-white/10 rounded-xl px-4 py-2.5 outline-none cursor-pointer hover:border-[#C2540A]/50 focus:border-[#C2540A] transition-colors"
          >
          ...
          <div className="flex items-center gap-2 bg-[#FAFAF8] dark:bg-[#14161B] border border-[#1C1F26]/15 dark:border-white/10 rounded-xl px-4 py-2.5 hover:border-[#C2540A]/50 focus-within:border-[#C2540A] transition-colors">
              ...
              >
                ...
                >
                  <Heart
                    ...
                    style={{ color: isFavorite ? "#8A3B4A" : "#6B6A62" }}
                  />
                </button>
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="font-semibold text-[#1C1F26] dark:text-[#FAFAF8] text-base mb-1 group-hover:text-[#C2540A] transition-colors leading-snug font-['Space_Grotesk',sans-serif]">
                    {s.name}
                  </p>
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    <Link
                      ...
                      className="flex items-center gap-2 text-sm text-[#6B6A62] dark:text-[#9B9A92] hover:text-[#C2540A] transition-colors"
                    >
                      <div
                    ...
                    <span className="text-xs font-semibold text-[#C2540A] bg-[#C2540A]/10 group-hover:bg-[#C2540A] group-hover:text-white px-3 py-1.5 rounded-xl transition-colors">
                      Book now
                    </span>
                  </div>
                </div>
