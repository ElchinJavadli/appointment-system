...
export default function ClientProfilePage() {
  ...
  const [rSelectedSlot, setRSelectedSlot] = useState(null);
  ...
  const renderAppointmentList = (list, { modifiable }) => {
    if (list.length === 0) {
      return (
                ...
                {modifiable && (
                  <div className="flex gap-2">
                    <button
                      ...
                      style={{ color: "#C2540A", borderColor: "#C2540A55" }}
                    >
              ...
              {isOpen && (
                <div className="mt-2 bg-white dark:bg-[#20242C] border border-dashed border-[#1C1F26]/20 dark:border-white/15 rounded-2xl p-4">
                      ...
                      <button
                        ...
                        className={`shrink-0 w-14 py-2 rounded-xl border flex flex-col items-center transition-colors ${
                          rDate === c.iso
                            ...
                            : "bg-[#FAFAF8] dark:bg-[#14161B] border-[#1C1F26]/15 dark:border-white/10 text-[#1C1F26] dark:text-[#FAFAF8] hover:border-[#C2540A]/50"
                        }`}
                      >
                  ...
                  <button
                    ...
                    className="text-xs text-[#C2540A] hover:underline mb-3"
                  >
                  ...
                  {rShowCustomDate && (
                    <input
                      type="date"
                      value={rDate}
                      onChange={(e) => { setRDate(e.target.value); setRSelectedSlot(null); }}
                      className="block w-full bg-[#FAFAF8] dark:bg-[#14161B] border border-[#1C1F26]/15 dark:border-white/10 rounded-xl px-3 py-2 mb-3 text-[#1C1F26] dark:text-[#FAFAF8] outline-none focus:border-[#C2540A]/60 transition-colors text-sm"
                    />
                  )}
                  ...
                  <button
                    ...
                    disabled={rSaving}
                    className="w-full bg-[#1C1F26] dark:bg-[#C2540A] text-white py-2 rounded-xl hover:bg-[#C2540A] dark:hover:bg-[#a3450a] disabled:opacity-60 transition-colors font-medium text-sm"
                  >
      ...
      <div className="p-6 sm:p-8 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 items-start">
          ...
          <div className="bg-white dark:bg-[#20242C] border border-[#1C1F26]/10 dark:border-white/10 rounded-2xl overflow-hidden lg:sticky lg:top-24">
            <div className="relative h-20" style={{ backgroundColor: "#C2540A" }}>
              <div
            ...
            <div className="px-6 pb-6">
              <div className="relative z-10 -mt-8 mb-3">
                {avatarUrl ? (
                  ...
                  <span className="w-16 h-16 rounded-full bg-[#1C1F26] dark:bg-[#C2540A] text-white flex items-center justify-center text-2xl font-bold font-['Space_Grotesk',sans-serif] ring-4 ring-white dark:ring-[#20242C] shadow-md">
                    {name?.[0]?.toUpperCase() || "?"}
                  </span>
                )}
              </div>
                ...
                <div className="bg-white dark:bg-[#20242C] border border-[#1C1F26]/10 dark:border-white/10 rounded-2xl p-6">
                  ...
                  <div className="flex items-center gap-4">
                    {avatarUrl ? (
                      ...
                      <span className="w-14 h-14 rounded-full bg-[#1C1F26] dark:bg-[#C2540A] text-white flex items-center justify-center text-xl font-bold font-['Space_Grotesk',sans-serif]">
                        {name?.[0]?.toUpperCase() || "?"}
                      </span>
                    )}

                    <div className="flex items-center gap-2">
                      <label className="cursor-pointer text-xs font-medium px-3 py-1.5 rounded-lg border border-[#1C1F26]/15 dark:border-white/10 text-[#1C1F26] dark:text-[#FAFAF8] hover:border-[#C2540A]/50 hover:text-[#C2540A] transition-colors">
