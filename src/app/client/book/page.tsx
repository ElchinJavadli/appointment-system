    ...
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-[#14161B]">
      ...
      <div className="p-6 sm:p-8 max-w-xl mx-auto">
        ...
        {activeService && (
          <div className="rounded-2xl overflow-hidden border border-[#1C1F26]/10 dark:border-white/10 mb-6 bg-white dark:bg-[#20242C]">
            <div className="relative w-full h-52 bg-[#FAFAF8] dark:bg-[#14161B]">
              ...
              <div className="absolute top-3 right-3 w-12 h-12 rounded-full bg-[#72b0ab] text-white flex items-center justify-center text-[11px] font-bold font-['IBM_Plex_Mono',monospace] leading-none text-center rotate-[6deg]">
            ...
            <button
              ...
              className={`shrink-0 w-14 py-2 rounded-xl border flex flex-col items-center transition-colors ${
                date === c.iso
                  ...
                  : "bg-white dark:bg-[#20242C] border-[#1C1F26]/15 dark:border-white/10 text-[#1C1F26] dark:text-[#FAFAF8] hover:border-[#72b0ab]/50"
              }`}
            >
        ...
        <button
          ...
          className="text-xs text-[#72b0ab] hover:underline mb-4"
        >
        ...
        {activeService && (
          <div className="rounded-2xl bg-white dark:bg-[#20242C] border border-[#1C1F26]/10 dark:border-white/10 overflow-hidden">
            <div className="p-4 flex items-center justify-between gap-4">
              ...
              <p className="text-lg font-bold text-[#72b0ab] font-['IBM_Plex_Mono',monospace] shrink-0">
                ${activeService.price}
              </p>
            </div>
            ...
            <div className="p-4">
              <button
                onClick={handleBook}
                className="w-full bg-[#1C1F26] dark:bg-[#72b0ab] text-white py-2.5 rounded-xl hover:bg-[#72b0ab] dark:hover:bg-[#5a8d8a] transition-colors font-medium"
              >
                Confirm Booking
              </button>
            </div>
